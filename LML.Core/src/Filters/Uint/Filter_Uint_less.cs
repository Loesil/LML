...
{
    /// <summary>
    /// Filter that checks if a uint property is less than a specific value.
    /// </summary>
    public class Filter_Uint_less : Filter_Property
    {
        private readonly uint _value;

        /// <summary>
        /// Creates a new uint less than filter.
        /// </summary>
        /// <param name="property">The property to filter on</param>
        /// <param name="value">The value to compare against</param>
        public Filter_Uint_less(MediaProperty property, uint value)
