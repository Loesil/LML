...
{
    /// <summary>
    /// Filter that checks if a uint property equals a specific value.
    /// </summary>
    public class Filter_Uint_equal : Filter_Property
    {
        private readonly uint _value;

        /// <summary>
        /// Creates a new uint equality filter.
        /// </summary>
        /// <param name="property">The property to filter on</param>
        /// <param name="value">The value to match against</param>
        public Filter_Uint_equal(MediaProperty property, uint value)
