...
{
    /// <summary>
    /// Filter that checks if a uint property does not equal a specific value.
    /// </summary>
    public class Filter_Uint_notEqual : Filter_Property
    {
        private readonly uint _value;

        /// <summary>
        /// Creates a new uint not equal filter.
        /// </summary>
        /// <param name="property">The property to filter on</param>
        /// <param name="value">The value to match against</param>
        public Filter_Uint_notEqual(MediaProperty property, uint value)
        ...
        {
            return FilterType.UintNotEqual;
        }
