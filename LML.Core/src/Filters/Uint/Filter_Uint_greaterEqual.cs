...
{
    /// <summary>
    /// Filter that checks if a uint property is greater than or equal to a specific value.
    /// </summary>
    public class Filter_Uint_greaterEqual : Filter_Property
    {
        private readonly uint _value;

        /// <summary>
        /// Creates a new uint greater than or equal filter.
        /// </summary>
        /// <param name="property">The property to filter on</param>
        /// <param name="value">The value to compare against</param>
        public Filter_Uint_greaterEqual(MediaProperty property, uint value)
        ...
        {
            return FilterType.UintGreaterEqual;
        }
