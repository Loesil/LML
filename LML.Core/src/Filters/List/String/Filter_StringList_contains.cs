...
namespace LML.Core.Filters
{
    ...
    /// </summary>
    public class Filter_StringList_contains : Filter_Property
    {
        ...
        public Filter_StringList_contains(MediaProperty property, string value, bool caseSensitive = false)
        ...
        public override bool Apply(MediaFile mediaFile)
        {
            ...
            return propertyValue.Find((v) => _caseSensitive ? v == this._value : v.ToLower() == this._value.ToLower()) != null;
        }

        /// <inheritdoc/>
        public override FilterType GetFilterType()
        {
            return FilterType.StringListContains;
        }
